...
int main( int argc, char *argv[] ){
	...
	std::vector<drawable*> objects {
		&my_ball,
		&my_cube,
		new wall{ sf::Vector2f { 0.0, 0.0 }, sf::Vector2f{640.0, wall_thickness } },
		new wall{ sf::Vector2f{ 0.0, 0.0 }, sf::Vector2f{ wall_thickness, 480.0 } },
		new wall{ sf::Vector2f{ (float) 640.0 - wall_thickness, 0.0 }, sf::Vector2f{ 640.0, 480.0 } }, //For some reason doing (float - float) returns double so we cast it to float again.
		new wall{ sf::Vector2f{ 0.0, (float) 480.0 - wall_thickness }, sf::Vector2f{ 640.0, 480.0 } }
	};
